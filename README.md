...
> **[ポートフォリオページ（HTML版）はこちら](https://yoshino523.github.io/okaimon-portfolio/portfolio.html)**
...
全ての機能をチケット番号付き仕様書（Markdown）で管理。累計27件。記憶やコンテキストに頼らず、設計判断の経緯を文書として残し、後から振り返れるようにしている。
